...
from prop_lang.util import project, conjunct, neg, disjunct
from prop_lang.variable import Variable


class FlaggingMonitor:
    ...
    def add_transition(self, src, condition: Formula, action: Formula, output: [Variable], tgt):
