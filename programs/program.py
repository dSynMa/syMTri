...
class Program:
    ...
    def __str__(self):
        ...
        text += "\t\t" + ",\n\t\t".join(tagged_states) + "\n"
        text += "\t}\n"
        text += "\tENVIRONMENT EVENTS {\n"
        text += "\t\t" + ",".join([str(e) for e in self.env_events]) + "\n"
        text += "\t}" + "\n"
        text += "\tCONTROLLER EVENTS {\n"
        text += "\t\t" + ",".join([str(e) for e in self.con_events]) + "\n"
        text += "\t}" + "\n"
        text += "\tMONITOR EVENTS {\n"
        text += "\t\t" + ",".join([str(e) for e in self.mon_events]) + "\n"
        text += "\t}" + "\n"
        text += "\tVALUATION {\n"
        ...
        text += "\t\t{" + "},\n\t\t{".join([str(t) for t in self.con_transitions]) + "}\n"
        text += "\t}" + "\n"
        text += "}"
